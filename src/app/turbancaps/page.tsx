...
async function getTurbanCaps(): Promise<Product[]> {
  try {
    const { db } = await connectToDatabase();
    
    const products = await db.collection("products")
      .find({
        category: "Turban & Caps"
      })
      .sort({ createdAt: -1 })
      .toArray();
...
const TurbancapsPage = async () => {
  const turbancapsProducts = await getTurbanCaps();
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto py-16 px-4">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-fashion-primary mb-4">Turban & Caps Collection</h1>
